...
if outnameext[:2] == "SR" and outnameext in srs:
    ...
    usesrs = ["SR1a","SR1b","SR1c","SR1cp","SR1d","SR2","SR2d"]
elif outnameext == "allhighmtplus":
    usesrs = ["SR1a","SR1b","SR1c","SR1cp","SR2"]
elif outnameext == "allhighmtd":
    usesrs = ["SR1a","SR1b","SR1c","SR1cp","SR1d","SR2"]
else:
    usesrs = srs
...
#for point in ["T2DegStop_300_270"]:
    ...
    for sr in usesrs:
        ...
        specifyExpectationWithError(c,sr,"signal",scaletuple(dictSignal[sr][point]["obs"]["nominal"],1.))
